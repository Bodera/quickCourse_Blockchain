...
using BlockchainServiceAlice.Models;
using BlockchainServiceAlice.API;

namespace BlockchainServiceAlice.Controllers
{ 
    public class HomeController : Controller
    {
        private static CryptoCurrency blockchain = BlockchainServiceAliceController.blockchain; //new CryptoCurrency();
